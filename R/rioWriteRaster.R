...
#' rioWriteRaster(t, "tests/testras.tif", writeRaster, format = "GTiff")
#' }

rioWriteRaster <- function(x, file, FUN = raster::writeRaster, data_source = rioGetDataSource(),
