...
#' @param data_source the name of the data source, if not set globally
...
#'
#' @return logical. if the operation was successful or not
...
rioFileDownload <- function(bucketpath, localfile, data_source = rioGetDataSource(),
  ...
  assert_that(rioFileExists(bucketpath, bucket = bucket, data_source = data_source),
